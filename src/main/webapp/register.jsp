        ...
        <div class="register_message">
            <form  method="post" id="registerform">
                <dl class="register_row">
                    <dt>Email地址：</dt>
                    <dd><input id="email" type="text" class="register_input" name="emailName"></dd>
                    <dd><div id="email_prompt"></div></dd>
                </dl>
                <dl class="register_row">
                    <dt>设置昵称：</dt>
                    <dd><input id="nickName" type="text" class="register_input" name="realName"></dd>
                    <dd><div id="nickName_prompt"></div></dd>
                </dl>
                <dl class="register_row">
                    <dt>设定密码：</dt>
                    <dd><input id="pwd" type="password" class="register_input" name="userPwd"></dd>
                ...
                <dl class="register_row">
                    <dt>性别：</dt>
                    <dd><input name="userGender" id="man" type="radio" value="男" checked="checked"> <label for="man">男</label></dd>
                    <dd> <input name="userGender" id="woman" type="radio" value="女"> <label for="woman">女</label></dd>
                </dl>
                <dl class="register_row">
                    <dt>所在地区：</dt>
                    <dd>
                    ...
                    <dd>
                        <select id="city"  style="width:130px;" name="userCity">
                            <option>请选择城市/地区</option>
                        </select>
                    </dd>
                </dl>
              <div class="registerBtn"><input  type="button" value="注册" onclick="useradd()"></div>
            </form>
        </div>
    </div>
</div>
